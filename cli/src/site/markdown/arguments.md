...
|       | \-\-disableGolangDep                   |                 | Sets whether or not the [experimental](../analyzers/index.html) Go Dependency Analyzer should be used.                       | false  |
|       | \-\-disableGolangMod                   |                 | Sets whether or not the [experimental](../analyzers/index.html) Go Mod Analyzer should be used.                              | false  |
