# Contributing to lighter-config
...
[new issue form](https://github.com/lighterio/lighter-config/issues/new).
...
4. [Pull requests](http://help.github.com/send-pull-requests/) should be made
   to the [master branch](https://github.com/lighterio/lighter-config/tree/master).

## Contributor Code of Conduct

As contributors and maintainers of `lighter-config`, we pledge to respect all
